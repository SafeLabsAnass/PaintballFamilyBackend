...
<div class="container mx-auto my-auto px-0">
    <div class="row justify-content-center">
        <div class="col-md-8  mt-5">
            <div class="card">
                <center><div class="card-header" style="font-size: x-large">{{ __('Register') }}</div></center>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="col-10 mx-auto pt-3 px-4 pt-1">
                            <div class="logo_box mx-auto text-center">
                                <img src="{{ asset('images/logo.png')}}" width="300" height="300" class="img-fluid mb-5">
                            </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="first_name" value="{{ old('Frist Name') }}" required autocomplete="first_name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="last_name" value="{{ old('Last_name') }}" required autocomplete="last_name" autofocus>
